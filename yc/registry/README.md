...
| <a name="input_roles"></a> [roles](#input\_roles) | The role that should be applied | <pre>list(object({<br/>    role    = optional(string)<br/>    members = optional(list(string))<br/>  }))</pre> | `[]` | no |
